...
export default function AIAnalysisResult({ isLoading, analysis }: AIAnalysisResultProps) {
  ...
  if (!analysis) {
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-900/30 rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
          No transcript was recorded during this call
        </p>
      </div>
    );
  }
